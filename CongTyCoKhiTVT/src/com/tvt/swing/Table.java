...
public class Table extends JTable{
    ...
    private void createShadow(){
        ...
        g2.fillRect(0, 0, width - margin, height - space);
    ...
    public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
        if (column == 0) {
            Icon icon = (Icon) getValueAt(row, 0);
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < getRowCount(); i++) {
            ...
            g2.setColor(new Color(44,103,176));
    ...
    public void fixTable(JScrollPane scroll){
        ...
        scroll.getViewport().setBackground(new Color(250,250,250,250));
        ScrollBarCustom sb = new ScrollBarCustom();
        sb.setBackground(new Color(250, 250, 250));
        scroll.setVerticalScrollBar(sb); 
        JPanel p = new JPanel();
        p.setBackground(new Color(250, 250, 250));
        scroll.setCorner(JScrollPane.UPPER_LEADING_CORNER, p);
    }
}
